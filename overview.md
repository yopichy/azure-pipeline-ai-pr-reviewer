# AI PR Reviewer Task for Azure Pipelines

The AI PR Reviewer for Azure Pipelines is designed to use AI models to review Pull Requests and provide feedback as comments in the Pull Request.
...
![contribute_to_pr](https://github.com/yopichy/azure-pipeline-ai-pr-reviewer/blob/main/images/contribute_to_pr.png?raw=true)
...
![allow_access_token](https://github.com/yopichy/azure-pipeline-ai-pr-reviewer/blob/main/images/allow_access_token.png?raw=true)
...
![configure_task](https://github.com/yopichy/azure-pipeline-ai-pr-reviewer/blob/main/images/configure_task.png?raw=true)
